...
<?php if (@mysql_num_rows($result_estado_do_utilizador)): ?>

	<?php $result_ativo_ou_inactivo = @mysql_fetch_assoc($result_estado_do_utilizador); ?>

		<?php if ($result_ativo_ou_inactivo['ativo'] == 1): ?>

		<p id="notaEstado">Clique para Desativar o Utilizador:</p>
			<div id="estadoRoteiro">
				<div style="padding-bottom: 12px; padding-top: 16px;" id="myRoteiroActivo" class="roteiroActivo">O Utilizador Está Ativo</div>
			</div>
		...
		<p id="notaEstado">Clique para Ativar o Utilizador:</p>
			<div id="estadoRoteiro">
				<div style="padding-bottom: 12px; padding-top: 16px;" id="myRoteiroInactivo" class="roteiroInactivo">O Utilizador Está Inativo</div>
			</div>

		<?php endif ?>

			<div id="eliminarRoteiroId">
				<a style="margin-top: 62px;" href="processaEliminarUtilizador.php?id=<?php echo $id_get_parametro ?>" id="myEliminarRoteiro" class="eliminarRoteiro">Eliminar Utilizador</a>
			</div>
